...
namespace error_code{
    ...
    const std::string LEX_1001 = "LEX_1001";
    const std::string LEX_1002 = "LEX_1002";
    const std::string LEX_2001 = "LEX_2001";
    const std::string LEX_2002 = "LEX_2002";
    const std::string LEX_2003 = "LEX_2003";
    const std::string LEX_3001 = "LEX_3001";
    const std::string LEX_3002 = "LEX_3002";
    const std::string LEX_4001 = "LEX_4001";
    ...
    const std::string SEM_2304 = "SEM_2304";
    ...
    const std::string PRE_0001 = "PRE_0001";
    const std::string PRE_0002 = "PRE_0002";
    const std::string PRE_0003 = "PRE_0003";

    const std::string CFG_0001 = "CFG_0001";
    const std::string CFG_0002 = "CFG_0002";
    const std::string CFG_0003 = "CFG_0003";
}
